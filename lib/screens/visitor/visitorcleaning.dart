...
class VisitorCleaningView extends StatefulWidget {
  VisitorCleaningView({Key? key}) : super(key: key);
  @override
  _VisitorCleaningViewState createState() => _VisitorCleaningViewState();
}

class _VisitorCleaningViewState extends State<VisitorCleaningView> {
