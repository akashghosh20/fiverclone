...
class VisitorAllItems extends StatefulWidget {
  VisitorAllItems({Key? key}) : super(key: key);
  @override
  _VisitorAllItemsState createState() => _VisitorAllItemsState();
}

class _VisitorAllItemsState extends State<VisitorAllItems> {
  final studentsStream = FirebaseFirestore.instance.collectionGroup('service_items').snapshots();
