...
class VisitorDeliveryView extends StatefulWidget {
  VisitorDeliveryView({Key? key}) : super(key: key);
  @override
  _VisitorDeliveryViewState createState() => _VisitorDeliveryViewState();
}

class _VisitorDeliveryViewState extends State<VisitorDeliveryView> {
